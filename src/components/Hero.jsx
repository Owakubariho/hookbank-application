...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      ...
      <h1 className="font-semibold font-poppins Ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full">
        Payment Method
      </h1>
      <p className="font-poppins font-normal text-dimWhite text-[18px] leading-[30.8px] mt-5 max-w-[470px]">
        Our team of experts uses a metholodology to identify credit cards most
